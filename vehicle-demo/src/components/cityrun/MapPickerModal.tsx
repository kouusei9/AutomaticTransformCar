        ...
        <div className="mt-4 flex justify-between items-center">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              style={{
                textShadow: (!tempStartNode || !tempDestNode || tempStartNode === tempDestNode) ? 'none' : '0 0 10px rgba(6, 182, 212, 0.8)',
                boxShadow: (!tempStartNode || !tempDestNode || tempStartNode === tempDestNode) ? 'none' : '0 0 20px rgba(6, 182, 212, 0.4)'
              }}
            >
              確定
            </button>
