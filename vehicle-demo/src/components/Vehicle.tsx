...
export const Vehicle: React.FC<VehicleProps> = ({
  ...
  const textures = {
    ...
    highwayFront: useLoader(THREE.TextureLoader, '/high_car_front.png'),
    highwayBack: useLoader(THREE.TextureLoader, '/high_car_back.png'),
    highwaySide: useLoader(THREE.TextureLoader, '/high_car_side.png'),
    airplaneFront: useLoader(THREE.TextureLoader, '/airplane_front.png'),
    airplaneBack: useLoader(THREE.TextureLoader, '/airplane_back.png'),
    airplaneSide: useLoader(THREE.TextureLoader, '/airplane_side.png'),
  }
